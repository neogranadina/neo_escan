...
"border-radius: 5px;")
        ...
        self.widget_11.setGeometry(QRect(10, 10, 317, 301))
        self.widget_11.setMinimumSize(QSize(0, 300))
        self.verticalLayout_37 = QVBoxLayout(self.widget_11)
        self.verticalLayout_37.setObjectName(u"verticalLayout_37")
        self.formLayout_7 = QFormLayout()
        self.formLayout_7.setObjectName(u"formLayout_7")
        self.formLayout_7.setLabelAlignment(Qt.AlignCenter)
        self.formLayout_7.setFormAlignment(Qt.AlignCenter)
        ...
        self.formLayout_7.setWidget(0, QFormLayout.LabelRole, self.endpointLabel)
        ...
        self.formLayout_7.setWidget(1, QFormLayout.LabelRole, self.endpointInput)
        ...
        self.formLayout_7.setWidget(1, QFormLayout.FieldRole, self.endpointInfo)
        ...
        self.formLayout_7.setWidget(2, QFormLayout.LabelRole, self.keyIDLabel)
        ...
        self.formLayout_7.setWidget(3, QFormLayout.LabelRole, self.keyIDInput)

        self.keyIDInfo = QPushButton(self.widget_11)
        self.keyIDInfo.setObjectName(u"keyIDInfo")
        self.keyIDInfo.setIcon(icon22)

        self.formLayout_7.setWidget(3, QFormLayout.FieldRole, self.keyIDInfo)
        ...
        self.formLayout_7.setWidget(4, QFormLayout.LabelRole, self.keyNameLabel)
        ...
        self.formLayout_7.setWidget(7, QFormLayout.LabelRole, self.appKeyInput)

        self.appKeyInfo = QPushButton(self.widget_11)
        self.appKeyInfo.setObjectName(u"appKeyInfo")
        self.appKeyInfo.setIcon(icon22)

        self.formLayout_7.setWidget(7, QFormLayout.FieldRole, self.appKeyInfo)


        self.verticalLayout_37.addLayout(self.formLayout_7)
        ...
        self.verticalLayout_37.addWidget(self.b2configSet)
...
"configuraci\u00f3n", None))
        ...
        self.keyNameLabel.setText(QCoreApplication.translate("MainWindow", u"keyName", None))
