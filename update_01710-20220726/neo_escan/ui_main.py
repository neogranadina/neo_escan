...
"border-radius: 5px;")
        ...
        self.b2config.setMinimumSize(QSize(100, 30))
        self.b2config.setMaximumSize(QSize(100, 30))
        self.b2config.setFont(font6)
...
"}")
        ...
        self.syncresullt.setGeometry(QRect(20, 120, 800, 600))
        self.syncresullt.setMinimumSize(QSize(800, 600))
        self.syncresullt.setWidgetResizable(True)
        self.promtUpload = QWidget()
        self.promtUpload.setObjectName(u"promtUpload")
        self.promtUpload.setGeometry(QRect(0, 0, 800, 600))
        self.promtUpload.setMinimumSize(QSize(800, 600))
        ...
        self.promtText.setMinimumSize(QSize(800, 600))
